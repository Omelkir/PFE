...
const Medecin = () => {
  ...
  return (
    <div className='bg-white mt-3 rounded-xl p-6'>
      <div className='pt-6'>
        <h1 className='text-center text-4xl font-semibold mb-12 items-center separator'>Doctors</h1>
      </div>
      ...
      <Grid container spacing={6} className='py-12 px-6'>
        {medecins?.length > 0 ? (
          ...
          <div className='text-center w-full py-6 text-gray-500'>Aucun médecin trouvé.</div>
        )}
      </Grid>
    </div>
  )
